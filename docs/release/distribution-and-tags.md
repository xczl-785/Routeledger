...
`docs/release/release-notes/`. The current Codex plugin release candidate is
[0.10.11](release-notes/0.10.11.md). The merged but untagged 0.4.3 candidate was
superseded before publication.

## Current status

- Published: Codex plugin 0.10.11 (tag `routeledger-plugin-v0.10.11`).

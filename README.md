...
当前推荐通过 Codex 插件使用 RouteLedger。稳定版为 0.4.1；0.4.2 是尚未合并或打 tag 的回归修复候选。`main` 是唯一发布干线，`codex-marketplace` 只保留为 0.3.3 的历史锚点分支：
...
- [Release policy](docs/release/release-policy.md)、[0.4.1 release note](docs/release/release-notes/0.4.1.md) 与 [0.4.2 candidate note](docs/release/release-notes/0.4.2.md) — 发布状态

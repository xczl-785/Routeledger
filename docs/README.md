...
- [Plugin release](guides/plugin-release.md) and the [release policy](release-policy.md) record the published 0.3.2 release baseline and its verification evidence; Git plugin publication does not publish `@routeledger/mcp` to npm.

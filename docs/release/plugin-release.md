...
The latest published plugin release is `routeledger-plugin-v0.4.3`;
...
runtime checks; 0.4.3 additionally publishes and anonymously revalidates its
durable checksum manifest.

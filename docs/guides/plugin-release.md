...
The prospective plugin release is `routeledger-plugin-v0.3.2`; it must resolve to the
...
smoke, then remove it. The prospective 0.3.2 path must be verified with branch

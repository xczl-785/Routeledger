...
`routeledger@routeledger-team` version 0.10.11 is the latest published Git
marketplace release, fixed by `routeledger-plugin-v0.10.11` after release
validation. It distinguishes explicit and system-default proposal reasons,
guides agents to author human-review reasons in the project locale, and keeps
legacy audit data readable.

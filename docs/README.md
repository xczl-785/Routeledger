...
- [Plugin release](release/plugin-release.md), the [release policy](release/release-policy.md), and the [0.4.3 release note](release/release-notes/0.4.3.md) record the current Git marketplace release state; Git plugin publication does not publish `@routeledger/mcp` to npm.

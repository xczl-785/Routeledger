...
- [Plugin release](release/plugin-release.md), the [release policy](release/release-policy.md), and the published [0.8.0 release note](release/release-notes/0.8.0.md) record the current Git marketplace baseline and release procedure; Git plugin publication does not publish `@routeledger/mcp` to npm.

...
- [Plugin release](release/plugin-release.md), the [release policy](release/release-policy.md), and the [0.4.2 release note](release/release-notes/0.4.2.md) record the current published Git marketplace release; Git plugin publication does not publish `@routeledger/mcp` to npm.

 ...
 */
export const resolvePhysicalPathForContainmentSync = (value) => {
...
export const isPhysicalPathContainedWithinSync = (root, candidate) => {
    ...
    const relativePath = path.relative(comparablePath(physicalRoot), comparablePath(physicalCandidate));
    return (relativePath.length === 0 ||
        (!relativePath.startsWith("..") && !path.isAbsolute(relativePath)));
};
export const arePhysicalPathsEqualSync = (left, right) => {

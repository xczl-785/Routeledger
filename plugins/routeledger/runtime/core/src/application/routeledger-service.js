...
import { createProject, setProjectContentLocale as setProjectContentLocaleDomain } from "../services/project-service.js";
...
import { VersionCommandService } from "./version-command-service.js";
import { L3ProposalReadService } from "./l3-proposal-read-service.js";
import { rebuildCanonicalL3ProposalDigest } from "./l3-proposal-security-port.js";
import { L3ProposalWriteService } from "./l3-proposal-write-service.js";
import { L3LegacyApprovalService } from "./l3-legacy-approval-service.js";
import { L3ExactAuthorizationService } from "./l3-exact-authorization-service.js";
import { L3OperationCommitService } from "./l3-operation-commit-service.js";
...
import { evaluateBatchCreateVersions } from "./batch-create-versions-planner.js";
import { isRouteOperationWorkflowMode } from "./types.js";
import { BatchCreateVersionsUseCase, buildBatchSnapshotHash } from "./batch-create-versions-use-case.js";
/** Reader-only version-structure projection, shared by hosts that cannot write. */
export const buildVersionStructureView = (snapshot, input) => {
...
export const buildVersionTransitionGuide = (snapshot, input) => {
...
const buildDigest = (projectId, actionType, targetId, payload, gateSnapshot) => rebuildCanonicalL3ProposalDigest({ projectId, actionType, targetId, payload, gateSnapshot });
        ...
        case "reorder_versions": {
            if (actionType === "insert_version" && payload.batchNormalizedPlan !== undefined) {
                ...
                return {
                    ...
                    gateSnapshot,
                    digest: buildDigest(snapshot.project.id, actionType, targetId, evaluated.payload, gateSnapshot)
                };
            }
...
const createL3ProposalSecurityPort = () => ({
    describe: (input) => buildOperationDescription(input.snapshot, input.actionType, input.targetId, input.payload, input.evaluatedAt)
});
...
export class RouteLedgerService {
    ...
    constructor(options) {
        ...
        this.batchCreateVersionsUseCase =
            options.batchCreateVersionsUseCase ??
                new BatchCreateVersionsUseCase({
                    ...
                    deps: options.deps,
                    buildDigestPreview: ({ snapshot, payload, evaluatedAt }) => buildDigest(snapshot.project.id, "insert_version", snapshot.project.id, payload, buildNoopGateSnapshot(evaluatedAt)),
        ...
        const trustedControlPlane = options.l3Authorization === undefined
            ? null
            : {
        ...
        this.l3OperationCommitService = new L3OperationCommitService({
            ...
            securityPort: l3ProposalSecurityPort,
            controlPlane: trustedControlPlane,
            commitCoordinator: options.l3Authorization === undefined
                ? null
    ...
    async initProject(input) {
        ...
        await this.saveProjectAggregate(snapshot);
        const documentation = this.documentSource === null
            ? undefined

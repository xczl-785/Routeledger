...
export const createRouteLedgerMcpRegistry = (
  ...
  const tools: ToolRegistration[] = [
    ...
    createCompositeTool(
      "inspect_route",
      "Inspect RouteLedger Route",
      "Inspect current work, route structure, gates, closeout, proposals, or authorization state.",
      [
    ...
    createCompositeTool(
      ...
      "Preflight or propose a normal Version lifecycle or route-structure change.",
      [

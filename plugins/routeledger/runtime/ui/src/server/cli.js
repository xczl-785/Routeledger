import { getMissionControlStatus, openMissionControlSource, parseLauncherArgs, registerMissionControlProject, runMissionControlServer, stopMissionControlHub } from "./launcher.js";
const main = async () => {
    ...
    if (command !== "serve")
        throw new Error(`Unknown RouteLedger UI command: ${command}`);
